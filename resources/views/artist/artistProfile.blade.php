    ...
    <form action="{{ route('artist.profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-2">
                <button type="submit" class="bg-red-600 hover:bg-red-500 text-gray-200 px-4 py-2 rounded-md flex items-center gap-2">
                    Save Changes
        ...
        <div class="bg-black rounded-lg p-6 mb-6">
            <div class="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <label class="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-md text-sm cursor-pointer">
                        Change Photo
                        <input type="file" name="profilePicture" class="hidden" accept="image/*" onchange="previewImage(event)">
                    </label>
                </div>
